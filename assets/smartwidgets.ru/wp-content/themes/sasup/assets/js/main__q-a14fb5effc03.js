(function ($) {
	...
	// menu-last class
	$(".sasup-header nav > ul > li").slice(-4).addClass("menu-last");
	...
	function brandActive(){
		...
		// sasup-brand-active-3
		if ($(".sasup-brand-active-3").length > 0) {
			let swiperbrand = new Swiper('.sasup-brand-active-3', {
				slidesPerView: 6,
				spaceBetween: 30,
				loop: true,
				infinite: false,
	...
	// data padding
	$("[data-top-padding]").each(function () {
		$(this).css("padding-top", $(this).attr("data-top-padding")+'px');
	})
	// data color
	$("[data-color]").each(function () {
		$(this).css("color", "url(" + $(this).attr("data-color") + ")")
	})
